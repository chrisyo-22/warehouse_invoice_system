...
const aiParserRouter = new Router();
...
// The system prompt that guides the AI's parsing behavior
...
// POST /ai/parse - Parse text into structured order data
aiParserRouter.post("/ai/parse", async (context) => {
  try {
